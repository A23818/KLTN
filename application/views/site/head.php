        ...
        <!-- End CSS -->
        <!-- favicon -->
        <link rel="shortcut icon"  type="image/x-icon" href="<?php echo public_url()?>/site/images/favicon.ico"> 
        <!-- the Javascript -->
		...
		<!-- Khai bao iD facebook -->
		<meta property="fb:app_id" content="145014112825119" />
		...
		<title>Hệ thống điện máy - Hammod Electric</title>  
