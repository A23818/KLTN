...
jQuery('document').ready(function(){
    ...
    'file': 'https://www.youtube.com/watch?v=09cqNW2lTV0',
    'controlbar': 'bottom',
    'width': '560',
    'height': '315',
    'autoplay' : true
...
<div class="usual-content">
     <div id="tab2"> 
		...
		<script>(function(d, s, id) {
		  ...
		  js.src = 'https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v2.11&appId=170796359666689';
		...
		<!-- Mặc đinh sẽ hiển thị bình luận như nhau ở các sản phẩm -->
